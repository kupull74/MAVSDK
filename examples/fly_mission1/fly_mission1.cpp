...
//mission1
        ...
        mission_item.latitude_deg = 47.395948; 
        mission_item.longitude_deg = 8.550772; 
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.399245; 
        mission_item.longitude_deg = 8.552446; 
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.400785; 
        mission_item.longitude_deg = 8.549377;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.400516; 
        mission_item.longitude_deg = 8.540888;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.399063; 
        mission_item.longitude_deg = 8.539907;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.395502; 
        mission_item.longitude_deg = 8.539726;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);
        ...
        mission_item.latitude_deg = 47.391897; 
        mission_item.longitude_deg = 8.545768;

        mission_item.latitude_deg = 47.392839; 
        mission_item.longitude_deg = 8.550053;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.395560; 
        mission_item.longitude_deg = 8.552195;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.398326; 
        mission_item.longitude_deg = 8.550914;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.399847; 
        mission_item.longitude_deg = 8.547387;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);
 
        mission_item.latitude_deg = 47.398638; 
        mission_item.longitude_deg = 8.542450;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.394388; 
        mission_item.longitude_deg = 8.544341;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.395587; 
        mission_item.longitude_deg = 8.549039;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.398337; 
        mission_item.longitude_deg = 8.551315;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);

        mission_item.latitude_deg = 47.398538; 
        mission_item.longitude_deg = 8.546449;
        mission_item.relative_altitude_m = 10.0f; // takeoff altitude
        mission_item.speed_m_s = 150.0f;
        mission_item.is_fly_through = false;
        mission_items.push_back(mission_item);
